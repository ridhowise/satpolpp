...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="{{ ( request()->is('dashboard/kategori') ) ?  'nav-item active' : 'nav-item ' }}">
                <a class="nav-link" href="/dashboard/kategori">
                    <i class="fas fa-fw fa-table"></i>
                    <span>kategori</span></a>
            </li>
            <li class="{{ ( request()->is('dashboard/postingan') ) ?  'nav-item active' : 'nav-item ' }}">
                <a class="nav-link" href="/dashboard/postingan">
                    <i class="fas fa-fw fa-table"></i>
